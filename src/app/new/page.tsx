    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50">
      ...
      <section className="relative overflow-hidden py-20 sm:py-32" style={{
        ...
        {/* <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-white mb-6 leading-tight">
         მალე
          ...
          <p className="text-xl sm:text-2xl text-[#fff] mb-8 max-w-3xl mx-auto">
            პირველ 500 მომხმარებელი მიიღებს ერთვიან უფასო ვიზიტებს პარტნიორ დაწესებულებებში
          </p>
      ...
      <section className="py-20 bg-gradient-to-br from-blue-600 via-purple-600 to-indigo-700">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-white mb-8 max-w-2xl mx-auto">
            <span className="text-yellow-300  text-2xl">შემოუერთდეთ აქციას და სრულიად უფასოდ მიიღეთ ერთთვიანი ვიზიტები პარტნიორ დაწესებულებებში</span>
           <span>
           {" "}  უფასო საწევროს მიიღებს პირველი 500 მომხმარებელი ასე რომ იჩარეთ
           </span>
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button size="lg" className="bg-white text-blue-600 hover:bg-gray-100 px-8 py-3 text-lg">
